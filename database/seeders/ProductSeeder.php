...
class ProductSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('product')->insert([
                ...
                "heart"=> 0,
                "quantity"=> 100,
                // "created_at"=> "2021-02-24T03:55:09.000000Z",
                // "updated_at"=> "2021-02-24T03:55:09.000000Z"
                ]);
        DB::table('product')->insert([
                "id"=> 3,
                "name"=> "Hoa lan",
                ...
                "heart"=> 0,
                "quantity"=> 100,
                // "created_at"=> "2021-02-24T03:57:05.000000Z",
                // "updated_at"=> "2021-02-24T03:57:05.000000Z"
                ]);
        DB::table('product')->insert([
                "id"=> 4,
                "name"=> "Hoa tulip",
                ...
                "heart"=> 0,
                "quantity"=> 100,
                // "created_at"=> "2021-02-24T04:00:55.000000Z",
                // "updated_at"=> "2021-02-24T04:00:55.000000Z"
                ]);
        DB::table('product')->insert([
                "id"=> 5,
                ...
                "heart"=> 1,
                "quantity"=> 5,
                // "created_at"=> "2021-03-02T16:22:51.000000Z",
                // "updated_at"=> "2021-03-02T16:22:51.000000Z"
                ]);
        DB::table('product')->insert([
            "id"=> 6,
            ...
            "heart"=> 0,
            "quantity"=> 55,
            // "created_at"=> "2021-03-02T16:32:43.000000Z",
            // "updated_at"=> "2021-03-02T16:32:43.000000Z"
        ]);
        DB::table('product')->insert([
            "id"=> 7,
            ...
            "heart"=> 0,
            "quantity"=> 47,
            // "created_at"=> "2021-03-02T16:52:33.000000Z",
            // "updated_at"=> "2021-03-02T16:52:33.000000Z"
        ]);
        DB::table('product')->insert([
            "id"=> 8,
            "name"=> "Bánh sinh nhật",
